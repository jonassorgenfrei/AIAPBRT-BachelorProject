...
def train_model(estimator,
    ...
    training_input_fn = lambda: input_fn(training_examples, training_targets["v"], batch_size=batch_size)
    predict_training_input_fn = lambda: input_fn(training_examples, training_targets["v"], num_epochs=1, shuffle=False)
