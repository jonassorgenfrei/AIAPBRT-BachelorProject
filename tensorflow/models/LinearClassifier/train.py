...
if __name__ == '__main__':
    ...
    handlers = [
        logging.FileHandler('model/train_v02.log'),
    ...
    if(trainModel) :
        ...
        if(evaluateModel) :
            ...
            # Test Data
            predict_test_input_fn = lambda: input_fn(test_examples, test_targets["hit"], num_epochs=1, shuffle=False)
        ...
        if(exportModel) :
            ...
            linear_classifier.export_saved_model('saved_model_2', serving_input_receiver_fn2);
